...
export const ARTICLES = [
  {
    ...
    desc: "Tout savoir sur le faire-part de mariage numérique : définition, avantages, prix, différence entre un faire-part digital statique et un faire-part interactif, et comment bien le choisir.",
    chapo:
    ...
    sections: [
      {
        ...
        p: [
          "Un faire-part de mariage numérique (ou faire-part digital) est une invitation en ligne que vous partagez par un simple lien — WhatsApp, SMS ou e-mail — au lieu d'un carton imprimé et posté.",
          "Dans sa version la plus aboutie, ce n'est plus une simple carte : c'est un véritable petit site-invitation privé, à vos prénoms, que vos invités peuvent même installer sur l'écran d'accueil de leur téléphone comme une application.",
        ],
      },
      {
        ...
        points: [
          "Zéro impression ni frais postaux : un lien à partager, c'est tout.",
          "Des réponses (RSVP) recueillies et comptées automatiquement, sans relances.",
      ...
      },
      {
        ...
        p: [
          "Beaucoup de faire-part digitaux ne sont qu'une image ou un PDF animé : joli, mais figé. Un faire-part vivant, lui, est interactif : RSVP en ligne, notifications, plan de table, cagnotte, jeux, album photo collaboratif…",
          "La différence se ressent surtout après l'envoi : un faire-part vivant continue de rendre service jusqu'au jour J et bien après, là où une carte digitale statique s'arrête à l'invitation.",
        ],
      },
      {
        ...
        points: [
          ...
          "Un accès privé : chaque invité ne voit que ce qui le concerne.",
      ...
      },
      {
        ...
        p: [
          "Les prix varient énormément : de quelques euros pour un modèle à remplir soi-même, à plusieurs centaines d'euros pour une création sur mesure et accompagnée.",
          "Chez Faire-part Vivant, les formules démarrent à 290 € (à partir de), avec un accompagnement humain de bout en bout et un devis personnalisé selon vos envies.",
        ],
      },
    ],
    faq: [
  ...
  },
  {
    ...
    chapo:
      "C'est l'une des premières questions que se posent les futurs mariés : garder le charme du papier, ou passer au digital ? Voici un comparatif honnête pour décider sereinement.",
    sections: [
      {
        h2: "Le budget",
        p: [
      ...
      },
      {
        h2: "L'écologie",
        p: [
          "Un faire-part digital, c'est zéro papier, zéro enveloppe, zéro transport. Pour des mariés soucieux de leur empreinte, l'argument pèse.",
        ],
      },
      {
        h2: "L'émotion et le souvenir",
        p: [
          "Le papier a un charme tactile indéniable, qu'on aime garder. Mais le digital n'est pas en reste : un faire-part vivant crée de l'émotion autrement — une invitation qui s'illumine à chaque réponse, un album qui se remplit pendant la fête, des souvenirs qu'on revit longtemps après.",
        ],
      },
      {
        h2: "La praticité",
        p: [
          "Côté organisation, le digital gagne haut la main : RSVP automatiques, comptage des couverts, relances inutiles, mises à jour instantanées si un détail change.",
        ],
      },
      {
        h2: "Le meilleur des deux mondes",
        p: [
          "Beaucoup de couples combinent : un joli carton papier minimaliste avec un QR code, qui renvoie vers le faire-part numérique complet. On garde le geste symbolique du papier, et toute la richesse du digital.",
          "C'est souvent la solution la plus élégante — et c'est exactement ce que permet un faire-part vivant.",
        ],
      },
    ],
    faq: [
    ...
    sections: [
      {
        ...
        p: [
          "RSVP (« répondez s'il vous plaît ») désigne la confirmation de présence de vos invités. C'est la donnée qui conditionne le traiteur, le plan de table, le nombre de couverts… bref, tout.",
        ],
      },
      {
        h2: "Pourquoi le RSVP « classique » vire au casse-tête",
        points: [
          "Des réponses éparpillées entre SMS, appels et bouche-à-oreille.",
          "Des relances gênantes à faire soi-même, une par une.",
          "Un tableur qui se désynchronise dès qu'un détail change.",
          "Des oublis sur les enfants et les régimes alimentaires.",
        ],
      },
      {
        h2: "Le RSVP en ligne : la solution",
        p: [
          ...
          "Fini les relances : les réponses arrivent toutes seules, et le total se met à jour automatiquement.",
        ],
      },
      {
