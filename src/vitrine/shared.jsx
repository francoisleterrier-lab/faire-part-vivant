...
export function Footer() {
  return (
    ...
    <footer className="vt-footer">
      ...
      {/* Signature « Création de site internet Sud-Toulousain — François Leterrier » (badge maison) */}
      <div className="vt-footer-credit">
        <a href="https://francoisleterrier.fr" target="_blank" rel="noopener"
          ...
          Création de site internet Sud-Toulousain —&nbsp;<b style={{ color: "#8fe6f0", fontWeight: 700 }}>François Leterrier</b>
        </a>
      </div>
    </footer>
    <FloatingWhatsApp />
